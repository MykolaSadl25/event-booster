...
},{"./js/getEvents":"1Tn5K","./js/createItems":"5yAc9","./js/modal.js":"jJ31c"}],"1Tn5K":[function(require,module,exports,__globalThis) {
...
;
async function getEvents(keyword, countryCode, page) {
...
async function render(keyword, countryCode, page) {
    const res = await (0, _getEvents.getEvents)(keyword, countryCode, page);
    if (!res._embedded) {
        if (page === 0) {
...
keywordSearch.addEventListener("input", (0, _lodashDebounceDefault.default)((e)=>{
...
const observer = new IntersectionObserver((entries)=>{
    entries.forEach(async (entry)=>{
        if (entry.isIntersecting) {
            page++;
            const res = await (0, _getEvents.getEvents)(keyword, code, page);
            render(keyword, code, page);
        }
    });
}, {
...
},{"./getEvents":"1Tn5K","lodash.debounce":"irvaP","@pnotify/core/dist/PNotify.js":"fay4s","@pnotify/mobile/dist/PNotifyMobile.js":"5RXYV","@pnotify/core/dist/BrightTheme.css":"grIyt","@pnotify/core/dist/PNotify.css":"c4y47","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}],"grIyt":[function() {},{}],"c4y47":[function() {},{}],"jJ31c":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _getEvents = require("./getEvents");
var _lodashDebounce = require("lodash.debounce");
var _lodashDebounceDefault = parcelHelpers.interopDefault(_lodashDebounce);
...
const eventListRef = document.querySelector(".event__list");
if (eventListRef) eventListRef.addEventListener("click", async (e)=>{
...
},{"./getEvents":"1Tn5K","lodash.debounce":"irvaP","@pnotify/core/dist/PNotify.js":"fay4s","@pnotify/mobile/dist/PNotifyMobile.js":"5RXYV","@pnotify/core/dist/BrightTheme.css":"grIyt","@pnotify/core/dist/PNotify.css":"c4y47","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"grIyt":[function() {},{}],"c4y47":[function() {},{}]},["iUuJv","fILKw"], "fILKw", "parcelRequire70a8", {})
